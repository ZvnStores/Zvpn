...
echo -e "       © Recode By Fv stores Project ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
###### 
...
data_ip="https://raw.githubusercontent.com/ZvnStores/izin/main/ip"
checking_sc() {
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ZvnStores/Zvpn/main/"
...
wget -q -O /usr/local/sbin/quota "${REPO}files/quota"
...
echo ""
read -p "$( echo -e "Klik ${YELLOW}[ ${NC}${YELLOW}Enter${NC} ${YELLOW}]${NC} For Install UDP Custom ") "
